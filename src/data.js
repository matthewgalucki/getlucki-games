export const TEAMS = [
  ...
  { abbr:'BUF', name:'Buffalo Bills',         price:30, conf:'AFC' },
  { abbr:'BAL', name:'Baltimore Ravens',      price:29, conf:'AFC' },
  { abbr:'DET', name:'Detroit Lions',         price:28, conf:'NFC' },
  { abbr:'WAS', name:'Washington Commanders', price:27, conf:'NFC' },
  { abbr:'GB',  name:'Green Bay Packers',     price:26, conf:'NFC' },
  { abbr:'LAR', name:'Los Angeles Rams',      price:25, conf:'NFC' },
  { abbr:'CIN', name:'Cincinnati Bengals',    price:24, conf:'AFC' },
  { abbr:'MIN', name:'Minnesota Vikings',     price:23, conf:'NFC' },
  { abbr:'DEN', name:'Denver Broncos',        price:22, conf:'AFC' },
  { abbr:'HOU', name:'Houston Texans',        price:21, conf:'AFC' },
  { abbr:'TB',  name:'Tampa Bay Buccaneers',  price:20, conf:'NFC' },
  { abbr:'LAC', name:'Los Angeles Chargers',  price:19, conf:'AFC' },
  { abbr:'SF',  name:'San Francisco 49ers',   price:18, conf:'NFC' },
  { abbr:'PIT', name:'Pittsburgh Steelers',   price:17, conf:'AFC' },
  { abbr:'SEA', name:'Seattle Seahawks',      price:16, conf:'NFC' },
  { abbr:'DAL', name:'Dallas Cowboys',        price:15, conf:'NFC' },
  { abbr:'ATL', name:'Atlanta Falcons',       price:14, conf:'NFC' },
  { abbr:'MIA', name:'Miami Dolphins',        price:13, conf:'AFC' },
  { abbr:'CHI', name:'Chicago Bears',         price:12, conf:'NFC' },
  { abbr:'ARI', name:'Arizona Cardinals',     price:11, conf:'NFC' },
  { abbr:'NE',  name:'New England Patriots',  price:10, conf:'AFC' },
  { abbr:'JAX', name:'Jacksonville Jaguars',  price:9,  conf:'AFC' },
  { abbr:'LV',  name:'Las Vegas Raiders',     price:8,  conf:'AFC' },
  { abbr:'IND', name:'Indianapolis Colts',    price:7,  conf:'AFC' },
  { abbr:'CAR', name:'Carolina Panthers',     price:6,  conf:'NFC' },
  { abbr:'NYJ', name:'New York Jets',         price:5,  conf:'AFC' },
  { abbr:'NYG', name:'New York Giants',       price:4,  conf:'NFC' },
  { abbr:'CLE', name:'Cleveland Browns',      price:3,  conf:'AFC' },
  { abbr:'NO',  name:'New Orleans Saints',    price:2,  conf:'NFC' },
  { abbr:'TEN', name:'Tennessee Titans',      price:1,  conf:'AFC' },
]
